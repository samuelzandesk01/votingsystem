    ...
    <div>
      ...
      >
        <div className="row my-4 mx-4 align-item-center pb-1">
          ...
          <div className="text-right pb-2" style={{ textAlign: "right" }}>
            <Link to="/CreateCoord">
              ...
              <div className="col-lg-6 col-xl-6 col-sm-12 col-xs-12">
                <div className="d-flex mb-3">
                  <div className="total counter">
                    <strong>
                      <p className="counter-title">Coordinators</p>
                    </strong>
                    <div className="">
                      <p>190</p>
                    </div>
              ...
              >
                <div>
                  <form className="row">
                    ...
                    <div className="col-lg-4">
                      <RegInput placeholder="Polling Units" />
                    </div>
                  </form>
                </div>
              </div>
            ...
            <table class="table">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <TableBtn className="tableBtn bg-danger">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
                        height="16"
